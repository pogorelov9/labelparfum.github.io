...
<div id="footer" class="clearfix">
    ...
    <div id="footer-wrapper">
        ...
        <div class="grid col-300 scroll-top"><a href="#scroll-top" title="<?php esc_attr_e( 'scroll to top', 'responsive' ); ?>"><?php _e( '&uarr; НАВЕРХ &uarr;', 'responsive' ); ?></a></div>
        
        <div class="grid col-300 fit powered">
            Сайт разработан специально для Maxtop.org
        </div><!-- end .powered -->
